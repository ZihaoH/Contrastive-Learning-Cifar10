...
import math
from models.lib.involution import involution
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv2 = involution(planes, 7, stride=1)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        #                        padding=1, bias=False)
        self.conv2 = involution(planes, 7, stride=stride)
...
if __name__ == '__main__':
    model = PyramidNetINV(dataset='cifar10', depth=50, alpha=200, num_classes=10, bottleneck=True).cuda()
    print(model)
