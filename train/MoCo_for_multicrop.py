...
class MoCoV3Multicrop():
    ...
    def ctr(self, logits, labels):
        ...
        return 2 * self.args.temperature * loss, acc1
        ...
        for epoch_counter in range(self.args.epochs):
            ...
            for (images, _) in train_loader:
                ...
                if not self.args.amp:
                    # compute output
                    logits1, labels1, logits2, labels2 = self.model(images)
                    loss1, top11 = self.ctr(logits1, labels1)
                    loss2, top12 = self.ctr(logits2, labels2)
            ...
            if self.args.kNN:
                acc = kNN(epoch_counter, self.model.encoder_q, train_loader_kNN, test_loader_kNN, feat_dim=self.args.dim, K=7)
